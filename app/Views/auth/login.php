...
<head>
  ...
  <title>Login - SIMA BAPELKES Jawa Tengah</title>
            ...
            <div class="card mb-0 shadow">
              <div class="card-body">
                <div class="text-center mb-4">
                  ...
                  <h5 class="text-muted fs-3 mb-0">Manajemen Aduan Peserta Pelatihan</h5>
                </div>
                ...
                <form action="<?= base_url('login') ?>" method="POST">
                  ...
                  <div class="d-flex align-items-center justify-content-center mb-3">
                    ...
                    <a class="text-primary fw-bold ms-2 fs-3" href="<?= base_url('register') ?>">Daftar Akun Baru</a>
                  </div>
                  ...
                  <div class="d-grid gap-2">
                    <a href="<?= base_url('aduan/buat') ?>" class="btn btn-outline-dark py-8 fs-4 rounded-2 d-flex align-items-center justify-content-center gap-2">
                      <i class="ti ti-speakerphone fs-5"></i> Ajukan Aduan Tanpa Login
                    </a>
                    <a href="<?= base_url('aduan/lacak') ?>" class="btn btn-outline-primary py-8 fs-4 rounded-2 d-flex align-items-center justify-content-center gap-2">
                      <i class="ti ti-search fs-5"></i> Lacak Status Aduan
                    </a>
                  </div>
